...
import center from '@/views/center'
    ...
    import lvyoudongtai from '@/views/modules/lvyoudongtai/list'
    ...
    import dictionaryLvyoudongtai from '@/views/modules/dictionaryLvyoudongtai/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryLvyoudongtai',
        name: '动态类型',
        component: dictionaryLvyoudongtai
    }
    ,{
